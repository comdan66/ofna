...
<input type="button" class='OA-ui-OA_Button' value="修改 <?php echo $feature_name_1; ?>" onClick='window.location.assign ("<?php echo $update_url; ?>");'/>
<hr/>
...
<?php
  ...
  <?php foreach ($objects as $object) { ?>
          <tr class='item' data-id='<?php echo $object->id;?>'>
            ...
            <td width='250'><?php echo $object->title;?></td>
