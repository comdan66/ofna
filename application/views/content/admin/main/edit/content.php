<section class="grid col-three-quarters mq2-col-full"> 
  ...
  <article id="navplace">
    <form action="<?php echo base_url (array ('admin', 'update'));?>" method="post" >
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>密碼</td>
          <td class="textleft">
            <input type="password" name='password' value="" placeholder='請輸入6~8個英數字元' pattern="[A-Za-z0-9]{6,8}" required title="請輸入6~8個英數字元" / >
            請輸入6~8個英數字元
          </td>
        </tr>
        <tr>
