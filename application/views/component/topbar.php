 ...
 */
  ...
  <?php } else if ($navitem['url'] === null) { ?>
          <li><a class='' title="<?php echo $navitem['title'];?>"><?php echo $navitem['name'];?></a></li>
  <?php } else { ?>
          <li><a class='' title="<?php echo $navitem['title'];?>" href="<?php echo $navitem['url'];?>"<?php echo ($navitem['target'] === null) ? '': (' target="' . $navitem['target'] . '"');?>><?php echo $navitem['name'];?></a></li>
  <?php }
      }
    }
  } ?>
