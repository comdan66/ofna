...
class Identity {
  ...
  public function get_identity ($identity) {
    ...
    switch ($identity) {
      ...
      case 'admins': $return = verifyNumber ($user_id) && verifyString ($fb_uid) && verifyString ($fb_name) && verifyString ($fb_email) && ($fb_uid == '100000100541088' || $fb_uid == '100006789307672'); break;
    }
    return $return;
  }
